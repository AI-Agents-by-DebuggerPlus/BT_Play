...
import com.taskertowpf.androidchatbttest98.MainActivity
...
class HeadsetMonitorService : Service() {
    ...
    private fun attachMediaSession() {
        ...
        val session = MediaSessionCompat(this, "AndroidChatBtTest98Headset").apply {
            setFlags(
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "androidchatbttest98_headset"
