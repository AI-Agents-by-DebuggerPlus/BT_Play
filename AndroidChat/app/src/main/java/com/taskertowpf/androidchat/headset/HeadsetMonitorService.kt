...
import com.taskertowpf.androidchat.MainActivity
...
class HeadsetMonitorService : Service() {
    ...
    override fun onCreate() {
        ...
        attachMediaSession()
        val app = application as com.taskertowpf.androidchat.AndroidChatApp
    ...
    private fun attachMediaSession() {
        ...
        val session = MediaSessionCompat(this, "AndroidChatHeadset").apply {
            setFlags(
    ...
    companion object {
        private const val CHANNEL_ID = "androidchat_headset"
