...
import com.taskertowpf.androidchatcopyv1.AndroidChatApp
import com.taskertowpf.androidchatcopyv1.MainActivity
...
class HeadsetMonitorService : Service() {
    ...
    private fun attachMediaSession() {
        ...
        val session = MediaSessionCompat(this, "AndroidChatCopyV1Headset").apply {
            setFlags(
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "androidchatcopyv1_headset"
