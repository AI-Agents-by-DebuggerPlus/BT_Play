package com.taskertowpf.androidchatbttest.ui
...
import com.taskertowpf.androidchatbttest.AppBuildInfo
import com.taskertowpf.androidchatbttest.MainViewModel
import com.taskertowpf.androidchatbttest.bluetooth.BluetoothDeviceRow
...
private fun SettingsScreen(viewModel: MainViewModel) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("sender_name = AndroidChatBtTest, content = [LOG:{category}] …")
            OutlinedTextField(
